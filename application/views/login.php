...
<head>
    ...
    <style>
        ...
        .jumbotron {
            background: rgba(100%, 100%, 500%, 0.3);
            color: #0275d8;
        }
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                <div class="jumbotron py-3 pt-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm <?= (form_error('username')) ? 'is-invalid' : ''; ?>" name="username" id="username" placeholder="Masukan Username" autocomplete="off" value="<?= set_value('username'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control form-control-sm <?= (form_error('password')) ? 'is-invalid' : ''; ?>" id="password" placeholder="Masukan Password" autocomplete="off" name="password">
                        <div class="invalid-feedback">
